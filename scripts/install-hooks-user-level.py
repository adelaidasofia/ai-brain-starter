...
# AND converts the block into an allow.
#
# Tracked as MYC-1031 (structural CI gate for this). Four instances so far;
# the most recent was introduced by an author who registered in both lists
# below, believed the hook was active, and said so in the commit message.
ABS_FINGERPRINTS = [
